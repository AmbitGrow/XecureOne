    ...
    <div>
      <div className="content-about">
        ...
        <div className="aboutpage-overall-container">
          ...
          <div className="ap-fourth-section core-value-section">
            <div className="title-tag core-value-tag">
              <p>Our Core Values</p>
            </div>
              ...
              <ul class="values-list">
                ...
                <li>
                  <p class="value-title">
                    ...
                    Ensuring complete data privacy and protection.
                  </p>
                </li>
                <li>
                  <p class="value-title">
