  ...
  useEffect(() => {
    let ctxs = gsap.context(() => {
      ...
      t1.from(
        ...
        .from(
          [
            ".preloader .outro-title .circle-logo p",
            ".split-overlay .outro-title .circle-logo p",
          ],
          {
            opacity: 0,
            y: "-5%",
  ...
  useEffect(() => {
    const ctxhome = gsap.context(() => {
      ...
      cards.forEach((card, index) => {
        ...
        const split = new SplitType(card.querySelector(".heading"), {
          types: "words, chars",
        });
        ...
        tl.from(
          ...
          .from(
            card.querySelector(".sub-heading"),
            {
              opacity: 0,
              y: 20,
              duration: 0.4,
          ...
          .from(
            card.querySelectorAll(".benefits > div"),
            {
              opacity: 0,
              x: -20,
              duration: 0.5,
          ...
          .from(
            card.querySelector(".price-duration"),
            {
              opacity: 0,
              y: 20,
              duration: 0.5,
      ...
      const splitfour = new SplitType(
        ".hp-fourth-section .heading .sub-heading span",
        { types: "words, chars" }
      );
      ...
      gsap.from(
        ".hp-fourth-section .boxs .profile",
        {
          opacity: 0,
          y: 50,
          stagger: 0.5,
      ...
      const splitfive = new SplitType(".hp-fiveth-section  .heading span", {
        types: "words, chars",
      });

      gsap.from(
        ".hp-fiveth-section  .heading span",
        {
          y: 50,
          opacity: 0,
          duration: 0.5,
        ...
        <div className="homepage-overall-container">
          ...
          <div className="hp-second-section service-section" ref={containerRef}>
            <div className="secondsec-left">
              <div className="blur-bg-circle"></div>
          ...
          <div className="hp-fourth-section client-testimonials">
            ...
            <div className="slider-container">
              ...
              >
                ...
                {/* <div className="swiper-button-prev-custom"><IoMdArrowDropleftCircle /></div> */}
                {/* <div className="swiper-button-next-custom"><IoMdArrowDroprightCircle /></div> */}
              </Swiper>
            </div>
          </div>
